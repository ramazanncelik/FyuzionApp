...
import MyFolloweds from '../../components/MyFolloweds';

const MyFollowedsModal = ({ isModalVisible, setIsModalVisible }) => {
    ...
    if (!loading) {
        return (
            <View className="w-full h-[75%] bg-white dark:bg-slate-700 rounded-lg px-2 pt-2">
                ...
                <MyFolloweds myFolloweds={myFolloweds} setIsModalVisible={setIsModalVisible} />
            </View>
        )
    } else {
        return <Loading />
...
export default MyFollowedsModal;