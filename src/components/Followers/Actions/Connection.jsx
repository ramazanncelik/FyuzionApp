        ...
        <>
            {connectionId ?
                ((getConnection_loading || removeConnection_loading) &&
                    <View
                        className="w-full p-3 items-center justify-center bg-blue-500 rounded-lg mb-1">
                    ...
                    <TouchableOpacity
                        ...
                        className="w-full p-2 items-center justify-center bg-blue-500 rounded-lg mb-1">
